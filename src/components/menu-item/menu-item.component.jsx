...
import { toogleDropDownHidden} from '../../redux/user/user.actions';
import { selectUserHidden } from '../../redux/user/user.selector';
...
const MenuItem = ({toogleDropDownHidden, hidden}) => {
	return(
		<nav className='main-menu'>
	        <ul className='menu-item'>
			  ...
			  <li  className='item useravt' onClick={toogleDropDownHidden}>
...
const mapDispatchToProps = dispatch => ({
	toogleDropDownHidden: () => dispatch(toogleDropDownHidden())
});

const mapStateToProps = createStructuredSelector({
	hidden: selectUserHidden
});
